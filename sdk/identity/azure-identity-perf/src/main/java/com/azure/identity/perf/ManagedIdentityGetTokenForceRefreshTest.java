...
public class ManagedIdentityGetTokenForceRefreshTest extends ServiceTest<IdentityPerfStressOptions> {
    ...
    public ManagedIdentityGetTokenForceRefreshTest(IdentityPerfStressOptions options) {
        super(options);
    }
    ...
    public Mono<Void> globalSetupAsync() {
        return super.globalSetupAsync().then(Mono.fromRunnable(() -> {
            ManagedIdentityCredentialBuilder builder
                = new ManagedIdentityCredentialBuilder().httpClient(this.httpClient);
