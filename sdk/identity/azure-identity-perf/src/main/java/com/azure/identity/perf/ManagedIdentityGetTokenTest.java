...
public class ManagedIdentityGetTokenTest extends ServiceTest<IdentityPerfStressOptions> {
    ...
    public ManagedIdentityGetTokenTest(IdentityPerfStressOptions options) {
        super(options);
    }
