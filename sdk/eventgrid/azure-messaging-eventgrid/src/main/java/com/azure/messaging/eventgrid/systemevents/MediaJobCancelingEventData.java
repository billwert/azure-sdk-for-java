...
@JsonTypeInfo(
    ...
    property = "#Microsoft.Media.JobCanceling")
@JsonTypeName("MediaJobCancelingEventData")
@Fluent
public final class MediaJobCancelingEventData {
     ...
     * @return the MediaJobCancelingEventData object itself.
     */
    @Generated
    public MediaJobCancelingEventData setPreviousState(MediaJobState previousState) {
     ...
     */
    @Generated
    public MediaJobCancelingEventData setState(MediaJobState state) {
        this.state = state;
        return this;
    }
