 ...
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "#Microsoft.Media.JobCanceled")
@JsonTypeName("MediaJobCanceledEventData")
@Fluent
public final class MediaJobCanceledEventData {
     ...
     */
    @Generated
    public MediaJobCanceledEventData setPreviousState(MediaJobState previousState) {
     ...
     */
    @Generated
    public MediaJobCanceledEventData setState(MediaJobState state) {
        this.state = state;
        return this;
    }
