...
@JsonTypeInfo(
    ...
    property = "#Microsoft.Media.JobOutputProcessing")
@JsonTypeName("MediaJobOutputProcessingEventData")
@Fluent
public final class MediaJobOutputProcessingEventData {
     ...
     * @return the MediaJobOutputProcessingEventData object itself.
     */
    @Generated
    public MediaJobOutputProcessingEventData setPreviousState(MediaJobState previousState) {
