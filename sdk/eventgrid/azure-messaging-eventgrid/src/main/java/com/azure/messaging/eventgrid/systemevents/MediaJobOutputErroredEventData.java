...
@JsonTypeInfo(
    ...
    property = "#Microsoft.Media.JobOutputErrored")
@JsonTypeName("MediaJobOutputErroredEventData")
@Fluent
public final class MediaJobOutputErroredEventData {
     ...
     * @return the MediaJobOutputErroredEventData object itself.
     */
    @Generated
    public MediaJobOutputErroredEventData setPreviousState(MediaJobState previousState) {
