 ...
 */
@Fluent
public final class MediaJobStateChangeEventData {
     ...
     */
    @Generated
    public MediaJobStateChangeEventData setPreviousState(MediaJobState previousState) {
     ...
     */
    @Generated
    public MediaJobStateChangeEventData setState(MediaJobState state) {
        this.state = state;
        return this;
    }
}
