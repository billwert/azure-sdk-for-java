...
public final class MediaLiveEventEncoderDisconnectedEventData {
    ...
    /**
     * Set the resultCode property: Gets the result code.
     *
     * @param resultCode the resultCode value to set.
     * @return the MediaLiveEventEncoderDisconnectedEventData object itself.
     */
    @Generated
    public MediaLiveEventEncoderDisconnectedEventData setResultCode(String resultCode) {
