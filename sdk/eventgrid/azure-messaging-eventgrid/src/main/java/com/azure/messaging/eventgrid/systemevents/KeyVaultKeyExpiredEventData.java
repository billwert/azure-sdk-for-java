...
public final class KeyVaultKeyExpiredEventData {
     ...
     */
    public KeyVaultKeyExpiredEventData setId(String id) {
        this.id = id;
        return this;
    }
     ...
     * @return the KeyVaultKeyExpiredEventData object itself.
     */
    public KeyVaultKeyExpiredEventData setVaultName(String vaultName) {
     ...
     * @return the KeyVaultKeyExpiredEventData object itself.
     */
    public KeyVaultKeyExpiredEventData setObjectType(String objectType) {
     ...
     * @return the KeyVaultKeyExpiredEventData object itself.
     */
    public KeyVaultKeyExpiredEventData setObjectName(String objectName) {
     ...
     * @return the KeyVaultKeyExpiredEventData object itself.
     */
    public KeyVaultKeyExpiredEventData setVersion(String version) {
     ...
     * @return the KeyVaultKeyExpiredEventData object itself.
     */
    public KeyVaultKeyExpiredEventData setNbf(Float nbf) {
        this.nbf = nbf;
        return this;
    }
